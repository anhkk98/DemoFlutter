...
class _HieulenhotoState extends State<Hieulenhoto> {
  ...
  Future getData() async {
    var url = Sever.Duongdanhieulenhoto;
                                ...
                                child: Slidable(
                                  ...
                                  secondaryActions: <Widget>[
                                    ...
                                    IconSlideAction(
                                      ...
                                      onTap: () {
                                        var url =
                                            Sever.Duongdandeletehieulenhoto;
                                        http.post(url, body: {
                                          'id': list[index]['id'],
                                        });
...
class _SecondScreenState extends State<SecondScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        appBar: AppBar(
          title: Text('Chi tiết lỗi vi phạm hiệu lệnh ô tô'),
        ),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Image.network(
                        widget.list[widget.index]['anhhloto'],
                      ...
                      child: Column(
                        ...
                        children: [
                          new Container(
                            ...
                            child: Text(
                              "Lỗi: " +
                                  widget.list[widget.index]['tenloihloto'],
                          ...
                          new Container(
                            ...
                            child: Text(
                              'Phạt tiền từ ' +
                                  widget.list[widget.index]['phattienhloto'],
                          ...
                          Text('    - ' +
                              widget.list[widget.index]['noidunghloto'])
                        ],
                      ),
                    ),
                  ],
